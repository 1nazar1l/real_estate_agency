...
class Owner(models.Model):
    ...
    pure_phone = PhoneNumberField('Нормализованый номер телефона', blank=True, null=True)
    apartments = models.ManyToManyField(Flat, verbose_name='Квартиры в собственности', related_name="owners", null=True, blank=True, db_index=True)
